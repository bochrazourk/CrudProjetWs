package com.zourk.projetws.adapter;
...
import com.zourk.projetws.EditActivity;
import com.zourk.projetws.R;
...
public class EtudiantAdapter extends RecyclerView.Adapter<EtudiantAdapter.EtudiantViewHolder> {
    ...
    String deleteUrl = "http://24.10.16.160/ProjetVolley/ws/deleteEtudiant.php";
    ...
    public void onBindViewHolder(@NonNull EtudiantViewHolder holder, int position) {
        ...
        if(etudiants.get(position).getImage() == null) {
            ...
            byte[] decodedString = Base64.decode(etudiants.get(position).getImage(), Base64.DEFAULT);
