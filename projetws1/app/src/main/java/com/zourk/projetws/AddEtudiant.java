...
public class AddEtudiant extends AppCompatActivity implements View.OnClickListener{
    ...
    private String link = "android.resource://com.zourk.projetws/drawable/avatar";
    RequestQueue requestQueue;
    String insertUrl = "http://24.10.16.160/ProjetVolley/ws/createEtudiant.php";
    ...
    public void onClick(View v) {
        ...
        if(v == remove) {
            link = "android.resource://com.zourk.projetws/drawable/avatar";
            bitmap = null;
            Glide
